          ...
          >
            ...
            <div className="space-y-4">
              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed transition-colors duration-300">
                I am a passionate Electronics and Communication Engineering student with strong interests in Data Analytics and Web Development. I strive to leverage technology to create impactful solutions.
              </p>

              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed transition-colors duration-300">
                Currently pursuing my Bachelor's degree with a focus on modern technologies, I enjoy working at the intersection of electronics, data science, and web development. My goal is to transform complex data into actionable insights while building innovative digital experiences.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-6">
              ...
              >
                ...
                <span className="text-gray-700 dark:text-gray-300 transition-colors duration-300">Graduating 2025</span>
              </motion.div>
